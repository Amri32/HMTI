...
export default function HomePage() {
  return (
    <>
      {/* ====== HERO / BERANDA ====== */}
      <section id="beranda" className="bg-[#343B66] min-h-screen flex items-center justify-center px-5 md:px-10">
        <div className="text-center max-w-[747px]">
          ...
          <div className="flex flex-col md:flex-row justify-center gap-4 md:gap-6">
            <a href="#struktur" className="inline-flex items-center gap-2.5 py-3 px-2.5 rounded-2xl bg-[#EAE0CF] w-full md:w-[302px] justify-center">
            ...
            <a href="#tentang" className="inline-flex items-center gap-2.5 py-3 px-2.5 rounded-2xl bg-[#EAE0CF] w-full md:w-[302px] justify-center">
      ...
      <Line />
      {/* ====== PROKER (placeholder) ====== */}
      <section id="proker" className="bg-[#343B66] min-h-screen flex items-center justify-center px-5 md:px-10">
        <p className="text-[#EAE0CF] text-4xl font-semibold">Program Kerja — Segera Hadir</p>
      </section>
    </>
  );
}
